...
phone = '5511999999999'
# token to test (email provided)
token_to_test = 'marioliver84@yahoo.com.br'
...
payload1 = {"to": phone, "message": "teste token email - header"}
...
payload2 = {"to": phone, "clientToken": token_to_test, "message": "teste token email - json"}
